...
function draw() {
  ...
  /** 
  *my own comments
  *  i = index so if we want it to start at 0. if it less then 6 as there are 6 things in the array then it will add it. the i ++ means 
  * that it will add it by one 
  */
...
function mousePressed() {
  ...
  /**
   * my comment 
   * push add  and if you use pop it will take out from the back
   * 
   * 
   */
   ...
   * 
   * 
   * this does similar to push and pop but instead of from the back it will add and take away from the back
   */
